...
// Play audio file - randomly pick from different pitch variations
function playGugnagAudio() {
    // Array of all the different pitch variations
    const audioFiles = [
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip.wav',
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip_1.wav',
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip_2.wav',
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip_3.wav',
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip_4.wav',
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip_5.wav',
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip_6.wav',
        'sully sounds/‎Audio Message from Sullivan Daniels 2 copy_bip_7.wav'
    ];

    // Randomly pick one
    const randomFile = audioFiles[Math.floor(Math.random() * audioFiles.length)];

    // Create new audio element with the random file
    const audio = new Audio(randomFile);

    // Random speed shift (playback rate between 0.85 and 1.15)
    const speedShift = Math.random() * 0.3 + 0.85; // 0.85 to 1.15
